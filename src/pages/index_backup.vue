...
<template>
  <div>
    <div
      class="bg-gradient-to-r from-indigo-300 via-purple-300 to-pink-300 h-50 drop-shadow-lg flex justify-center items-center gap-4">
      <h1 class="text-[50px] font-bold drop-shadow-xl">Cupcake Store</h1>
      <img
        class="w-[55px] h-[55px] drop-shadow-xl"
        src="/src/assets/images/cupcake-icon.png"
        alt="cupcake-icon" />
    </div>
    <div class="my-6 mx-32 p-2 text-[18px] text-center">
      <p class="mb-2">
        Cupcake Store é uma lojinha de cupcakes com a maior variedade de sabores
        que você vai encontrar!
      </p>
      <p>
        Confira abaixo os sabores disponíveis e aproveite essas delícias
        diretamente na sua casa!
      </p>
    </div>
    <div class="my-6 py-6 w-full flex flex-col justify-center items-center">
      <div
        class="p-10 flex justify-center items-center bg-gradient-to-l from-pink-100 to-pink-200 drop-shadow-lg rounded w-200 mb-4">
        <div
